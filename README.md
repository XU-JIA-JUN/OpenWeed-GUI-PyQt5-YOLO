...
## Environment Requirements:
 OpenWeedGUI was developed using Linux with MATLAB installed (refer below). 
 
 can be operated any version of Windows and
 
 It should be noted that some optional features cannot be used when run on Linux.
